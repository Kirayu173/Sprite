...
use runtime_protocol::error::Result as CodexResult;
...
use sandboxing::landlock::SPRITE_LINUX_SANDBOX_ARG0;
...
fn exit_with_bwrap_build_error(err: runtime_protocol::error::CodexErr) -> ! {
...
fn apply_inner_command_argv0_for_launcher(
    ...
    if supports_argv0 {
        argv.splice(
            ...
            ["--argv0".to_string(), SPRITE_LINUX_SANDBOX_ARG0.to_string()],
        );
        return;
    }
