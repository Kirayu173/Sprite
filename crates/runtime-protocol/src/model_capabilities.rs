//! Shared model metadata types exchanged between runtime services and clients.
//!
...
/// Metadata describing a runtime-supported model.
#[derive(Debug, Clone, Deserialize, Serialize, TS, JsonSchema, PartialEq)]
...
/// Model metadata returned by the runtime model catalog endpoint.
