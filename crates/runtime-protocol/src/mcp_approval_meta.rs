...
pub const SOURCE_INTEGRATION: &str = "integration";
pub const INTEGRATION_ID_KEY: &str = "integration_id";
pub const INTEGRATION_NAME_KEY: &str = "integration_name";
pub const INTEGRATION_DESCRIPTION_KEY: &str = "integration_description";
