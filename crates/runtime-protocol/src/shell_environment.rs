...
pub const SPRITE_THREAD_ID_ENV_VAR: &str = "SPRITE_THREAD_ID";
    ...
    I: IntoIterator<Item = (String, String)>,
{
    ...
    if let Some(thread_id) = thread_id {
        env_map.insert(SPRITE_THREAD_ID_ENV_VAR.to_string(), thread_id.to_string());
    }
...
mod windows_tests {
    ...
    fn core_inherit_preserves_windows_startup_vars_case_insensitively() {
        let vars = make_vars(&[
            ...
            ("AppData", "C:\\Users\\sprite\\AppData\\Roaming"),
            ("TmpDir", "C:\\Temp\\custom"),
            ("SPRITE_API_KEY", "secret"),
        ]);
        ...
        let expected = HashMap::from([
            ...
            (
                "AppData".to_string(),
                "C:\\Users\\sprite\\AppData\\Roaming".to_string(),
            ),
...
mod non_windows_tests {
    ...
    fn core_inherit_preserves_non_windows_core_vars_case_insensitively() {
        ...
        let expected = HashMap::from([
            ...
            ("home".to_string(), "/home/sprite".to_string()),
