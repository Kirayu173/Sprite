...
//! `~/.sprite/config.toml` and normalizes user-entered key specs into canonical
//! forms consumed by runtime keymap resolution.
//!
//! Responsibilities:
//!
...
See the Sprite keymap documentation for supported actions and examples."
                .to_string(),
        );
    }
