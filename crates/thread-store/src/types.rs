...
use runtime_protocol::protocol::ThreadMemoryMode as MemoryMode;
...
pub struct CreateThreadParams {
    /// Thread id generated by Sprite before opening persistence.
...
pub struct StoredThread {
    ...
    /// Last observed usage-limit/rate snapshot.
...
impl ThreadMetadataPatch {
    ...
    pub fn merge(&mut self, next: Self) {
        ...
        if next.usage_limits.is_some() {
            self.usage_limits = next.usage_limits;
        }
