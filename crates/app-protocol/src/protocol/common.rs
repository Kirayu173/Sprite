...
client_request_definitions! {
    ...
    /// Spawn a standalone process (argv vector) without a managed sandbox.
...
/// Superset of [`runtime_file_search::FileMatch`]
#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, JsonSchema, TS)]
...
mod tests {
    ...
    fn serialize_initialize_with_opt_out_notification_methods() -> Result<()> {
        let request = ClientRequest::Initialize {
            ...
            params: v1::InitializeParams {
                client_info: v1::ClientInfo {
                    name: "sprite_vscode".to_string(),
                    title: Some("App VS Code Extension".to_string()),
                    version: "0.1.0".to_string(),
                },
    ...
    fn serialize_mcp_server_elicitation_request() -> Result<()> {
        ...
        let params = v2::McpServerElicitationRequestParams {
            ...
            server_name: "sprite_apps".to_string(),
