...
pub struct InitializeResponse {
    ...
    /// Absolute path to the server's $workspace_home directory.
    pub workspace_home: AbsolutePathBuf,
...
pub struct ApplyPatchApprovalParams {
    pub conversation_id: ThreadId,
    /// Use to correlate this with [runtime_protocol::protocol::PatchApplyBeginEvent]
    /// and [runtime_protocol::protocol::PatchApplyEndEvent].
    pub call_id: String,
...
pub struct ExecCommandApprovalParams {
    pub conversation_id: ThreadId,
    /// Use to correlate this with [runtime_protocol::protocol::ExecCommandBeginEvent]
    /// and [runtime_protocol::protocol::ExecCommandEndEvent].
    pub call_id: String,
