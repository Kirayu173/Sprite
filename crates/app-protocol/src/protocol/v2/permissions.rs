...
use runtime_protocol::approvals::ExecPolicyAmendment as CoreExecPolicyAmendment;
use runtime_protocol::approvals::NetworkApprovalContext as CoreNetworkApprovalContext;
use runtime_protocol::approvals::NetworkApprovalProtocol as CoreNetworkApprovalProtocol;
use runtime_protocol::approvals::NetworkPolicyAmendment as CoreNetworkPolicyAmendment;
use runtime_protocol::approvals::NetworkPolicyRuleAction as CoreNetworkPolicyRuleAction;
use runtime_protocol::models::ActivePermissionProfile as CoreActivePermissionProfile;
...
impl SandboxPolicy {
    pub fn to_core(&self) -> runtime_protocol::protocol::SandboxPolicy {
        match self {
            SandboxPolicy::DangerFullAccess => {
                runtime_protocol::protocol::SandboxPolicy::DangerFullAccess
            }
...
impl From<runtime_protocol::protocol::SandboxPolicy> for SandboxPolicy {
    fn from(value: runtime_protocol::protocol::SandboxPolicy) -> Self {
        match value {
            runtime_protocol::protocol::SandboxPolicy::DangerFullAccess => {
                SandboxPolicy::DangerFullAccess
            }
            runtime_protocol::protocol::SandboxPolicy::ReadOnly { network_access } => {
                SandboxPolicy::ReadOnly { network_access }
            }
            runtime_protocol::protocol::SandboxPolicy::ExternalSandbox { network_access } => {
