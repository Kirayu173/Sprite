...
use runtime_protocol::mcp::Resource as McpResource;
pub use runtime_protocol::mcp::ResourceContent as McpResourceContent;
use runtime_protocol::mcp::ResourceTemplate as McpResourceTemplate;
use runtime_protocol::mcp::Tool as McpTool;
...
impl McpServerElicitationAction {
    pub fn to_core(self) -> runtime_protocol::approvals::ElicitationAction {
        match self {
            Self::Accept => runtime_protocol::approvals::ElicitationAction::Accept,
            Self::Decline => runtime_protocol::approvals::ElicitationAction::Decline,
            Self::Cancel => runtime_protocol::approvals::ElicitationAction::Cancel,
        }
    }
}
...
pub struct McpServerElicitationRequestParams {
    pub thread_id: String,
    /// Active agent turn when this elicitation was observed, if app-server could correlate one.
    ///
