...
pub enum ConfigLayerSource {
    ...
    /// User config layer from the workspace home/config.toml. This layer is special
    ...
    /// Path to a project-local config folder. There could be multiple of
...
pub struct ExternalAgentConfigDetectParams {
    /// If true, include detection under the user's home (the conventional workspace directories, etc.).
    #[serde(default, skip_serializing_if = "std::ops::Not::not")]
