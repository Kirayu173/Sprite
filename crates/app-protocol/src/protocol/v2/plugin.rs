...
use runtime_protocol::protocol::SkillDependencies as CoreSkillDependencies;
use runtime_protocol::protocol::SkillInterface as CoreSkillInterface;
...
pub struct PluginListParams {
    /// Optional working directories used to discover local plugin collections.
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct CatalogLoadErrorInfo {
    pub catalog_path: AbsolutePathBuf,
    pub message: String,
}
...
pub struct PluginReadParams {
    #[ts(optional = nullable)]
    pub catalog_path: Option<AbsolutePathBuf>,
