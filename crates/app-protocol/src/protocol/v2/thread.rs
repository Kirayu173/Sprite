...
pub struct ThreadStartParams {
    ...
    /// If true, opt into emitting raw provider items on the event stream.
...
pub struct ThreadResumeParams {
    ...
    /// [UNSTABLE] Hosted runtime resume payload. Do not use from general clients.
...
impl From<runtime_protocol::protocol::ThreadGoal> for ThreadGoal {
    fn from(value: runtime_protocol::protocol::ThreadGoal) -> Self {
        Self {
...
impl ThreadMemoryMode {
    ...
    pub fn to_core(self) -> runtime_protocol::protocol::ThreadMemoryMode {
        match self {
            Self::Enabled => runtime_protocol::protocol::ThreadMemoryMode::Enabled,
            Self::Disabled => runtime_protocol::protocol::ThreadMemoryMode::Disabled,
        }
    }
}
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct ThreadApproveAutoReviewDeniedActionParams {
    pub thread_id: String,
    /// Serialized `runtime_protocol::protocol::AutoReviewAssessmentEvent`.
    pub event: JsonValue,
}
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct ThreadApproveAutoReviewDeniedActionResponse {}
...
pub struct ThreadInjectItemsParams {
    pub thread_id: String,
    /// Raw provider items to append to the thread's model-visible history.
