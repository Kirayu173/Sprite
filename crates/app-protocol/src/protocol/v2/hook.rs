...
use runtime_protocol::protocol::HookOutputEntry as CoreHookOutputEntry;
use runtime_protocol::protocol::HookOutputEntryKind as CoreHookOutputEntryKind;
use runtime_protocol::protocol::HookRunStatus as CoreHookRunStatus;
use runtime_protocol::protocol::HookRunSummary as CoreHookRunSummary;
...
v2_enum_from_core!(
    pub enum HookOutputEntryKind from CoreHookOutputEntryKind {
        Warning, Stop, Notice, Context, Error
    }
);
