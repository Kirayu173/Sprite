...
/// Runtime operation requested by the model, a JS code cell, or Sprite itself.
///
...
pub struct ToolCall {
    ...
    /// Original invocation at the runtime tool boundary.
    ///
    ...
    /// they describe how Sprite executed the request, not what the caller sent.
