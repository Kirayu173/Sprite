...
/// Shared recorder context for inference attempts within one runtime activation.
...
pub use thread::SPRITE_ROLLOUT_TRACE_ROOT_ENV;
...
/// Request data for the canonical runtime tool boundary.
...
/// Append-only writer used by hot-path Sprite instrumentation.
