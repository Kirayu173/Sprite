...
//! sprite home directory creation and git safe.directory injection so sandboxed
...
/// Ensure the sandbox sprite home directory exists.
pub fn ensure_sprite_home_exists(p: &Path) -> Result<()> {
