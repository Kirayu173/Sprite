...
const SESSION_NAME: &str = "Sprite Windows Sandbox WFP";
const PROVIDER_NAME: &str = "Sprite Windows Sandbox WFP";
const PROVIDER_DESCRIPTION: &str = "Persistent WFP provider for Sprite Windows sandbox filters";
const SUBLAYER_NAME: &str = "Sprite Windows Sandbox WFP";
const SUBLAYER_DESCRIPTION: &str = "Persistent WFP sublayer for Sprite Windows sandbox filters";

// WFP identifies persistent providers, sublayers, and filters by stable GUIDs.
// These values are Sprite-owned identities; do not regenerate them unless we
...
/// Installs the persistent Sprite WFP filters for `account`.
///
...
/// Ensures the persistent Sprite WFP provider exists.
...
/// Ensures the persistent Sprite sublayer exists under the Sprite provider.
