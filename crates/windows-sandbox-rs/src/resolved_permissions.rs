            ...
            .retain(|FileSystemSandboxEntry { path, .. }| {
                !matches!(
                    ...
                    FileSystemPath::Special {
                        value: runtime_protocol::permissions::FileSystemSpecialPath::Tmpdir
                            | runtime_protocol::permissions::FileSystemSpecialPath::SlashTmp,
                    }
                )
            });
...
mod tests {
    ...
    use runtime_protocol::models::ManagedFileSystemPermissions;
