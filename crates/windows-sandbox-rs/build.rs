...
const SETUP_BIN: &str = "sprite-windows-sandbox-setup";
const SETUP_MANIFEST: &str = "sprite-windows-sandbox-setup.manifest";
...
fn main() -> Result<(), String> {
    ...
    // Keep this scoped to the setup helper so Sprite binaries that link the
