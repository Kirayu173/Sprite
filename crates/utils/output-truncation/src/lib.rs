//! Helpers for truncating tool and exec output using [`TruncationPolicy`](runtime_protocol::protocol::TruncationPolicy).

use runtime_protocol::models::FunctionCallOutputContentItem;
pub use utils_string::approx_bytes_for_tokens;
pub use utils_string::approx_token_count;
pub use utils_string::approx_tokens_from_byte_count;
use utils_string::truncate_middle_chars;
use utils_string::truncate_middle_with_token_budget;

pub use runtime_protocol::protocol::TruncationPolicy;
