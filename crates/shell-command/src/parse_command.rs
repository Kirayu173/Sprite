...
/// The easiest way to iterate is to add unit tests and fix the implementation against them.
...
/// Tests are at the top to encourage using TDD to fix the implementation.
mod tests {
    use super::*;
